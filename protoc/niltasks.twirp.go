...
// NewToDoItemsProtobufClient creates a Protobuf client that implements the ToDoItems interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewToDoItemsProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) ToDoItems {
...
func (c *toDoItemsProtobufClient) GetItems(ctx context.Context, in *GetItemsRequest) (*GetItemsResponse, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetItemsRequest) (*GetItemsResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetItemsRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetItemsRequest) when calling interceptor")
					}
...
func (c *toDoItemsProtobufClient) callGetItems(ctx context.Context, in *GetItemsRequest) (*GetItemsResponse, error) {
...
// NewToDoItemsJSONClient creates a JSON client that implements the ToDoItems interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewToDoItemsJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) ToDoItems {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *toDoItemsJSONClient) GetItems(ctx context.Context, in *GetItemsRequest) (*GetItemsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protoc")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoItems")
	ctx = ctxsetters.WithMethodName(ctx, "GetItems")
	caller := c.callGetItems
...
// ========================
// ToDoItems Server Handler
// ========================

type toDoItemsServer struct {
	ToDoItems
	interceptor      twirp.Interceptor
...
// NewToDoItemsServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewToDoItemsServer(svc ToDoItems, opts ...interface{}) TwirpServer {
...
func (s *toDoItemsServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *toDoItemsServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// ToDoItemsPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const ToDoItemsPathPrefix = "/twirp/protoc.ToDoItems/"

func (s *toDoItemsServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "protoc")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoItems")
	...
	if pkgService != "protoc.ToDoItems" {
...
func (s *toDoItemsServer) serveGetItems(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *toDoItemsServer) serveGetItemsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetItems")
	...
	reqContent := new(GetItemsRequest)
	...
	handler := s.ToDoItems.GetItems
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetItemsRequest) (*GetItemsResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.ToDoItems.GetItems(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetItemsResponse)
...
func (s *toDoItemsServer) serveGetItemsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetItems")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *toDoItemsServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *toDoItemsServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *toDoItemsServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "protoc", "ToDoItems")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
